    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (myMonster.hitPoints >= 1)
            {
                ...
                if (monsterAction == 1 && playerRun >= 6)
                {
                    ...
                    else if (hitMonster >= 6)
                    {
                        ...
                        Console.WriteLine(hitMonster);
                        myPlayer.hitPoints -= 20;
                    }
                    else if (hitMonster >= 19)
                    {
                        Console.WriteLine(myMonster.name + "crits");
                        Console.WriteLine(hitMonster);
                        myPlayer.hitPoints -= 50;
                    }
                }

                else if (monsterAction == 2 && myMonster.hitPoints <= 50)
                {
                    if (monsterRun <= 9)
                    {
        ...
        static void playerAttack()
        {
            ...
            if (hitPlayer == 1)
            {
                ...
                Console.WriteLine(myPlayer.hitPoints);
            }
            else if (hitPlayer <= 5)
            {
            ...
            else if (hitPlayer >= 6)
            {
                ...
                Console.WriteLine(hitPlayer);
                myMonster.hitPoints -= 10;
                Console.WriteLine(myMonster.hitPoints);
            }
